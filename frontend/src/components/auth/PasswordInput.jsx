...
export default function PasswordInput({
  ...
  if (variant === "new") {
    ...
    errorMessage = hasError ? "Passwort erfüllt nicht alle Regeln." : null;
  } else if (variant === "repeat") {
    hasError = value.length > 0 && compareTo.length > 0 && value !== compareTo;
    errorMessage = hasError ? "Passwörter stimmen nicht überein." : null;
  }
  ...
  return (
    <>
      <AppInput
        ...
        placeholder={placeholder || (variant === "repeat" ? "Repeat Password" : "Password")}
