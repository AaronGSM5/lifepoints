    ...
    <View style={styles.container}>
      <SelectableOptionCard label={t("Bright")} isSelected={!MyTheme.isDark} onPress={changeToBright}>
        <Icon
          name="sun"
          size={36}
          color={MyTheme.isDark ? MyTheme.muted : MyTheme.primaryAccent}
          outline={MyTheme.isDark}
        />
      ...
      <SelectableOptionCard label={t("Dark")} isSelected={MyTheme.isDark} onPress={changeToDark}>
        <Icon
          name="moon"
          size={36}
          color={MyTheme.isDark ? MyTheme.primaryAccent : MyTheme.muted}
          outline={!MyTheme.isDark}
        />
      </SelectableOptionCard>
    </View>
