  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.headerRow}>
        <AppText type="title" style={{ flex: 1, marginRight: Spacing.sm }}>
          {title}
        </AppText>
      ...
      <View style={styles.bodyRow}>
        ...
        <View style={styles.iconContainer}>
          ...
          <MaterialCommunityIcons name={theme.icon} size={55} color={theme.color} style={styles.mainIcon} />
        </View>
        {/* Rechte Seite: Stats (LP und XP) */}
        <View style={styles.statsContainer}>
          {/* LP (Blüten) */}
          <View style={styles.statItem}>
            <AppText type="title" style={{ fontSize: 16 }}>
              {lp}
            </AppText>
