    ...
    <ScreenWrapper scrollable>
        ...
        <View style={styles.createCard}>
          <View style={styles.createCardLeft}>
            ...
            <View>
              <AppText bold style={styles.createCardTitle}>Create Community</AppText>
              <AppText style={styles.createCardSubtitle}>Start your own hub</AppText>
            </View>
          </View>
          <TouchableOpacity style={styles.addBtnPrimary}>
            <MaterialIcons name="add" size={24} color={MyTheme.background} />
          </TouchableOpacity>
        </View>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.horizontalScroll}>
          {myCommunities.map((item, index) => (
            <View key={index} style={styles.communityCard}>
              ...
              <AppText bold style={styles.cardTitle} numberOfLines={1}>{item.title}</AppText>
          ...
          {recommendedData.map((item, index) => (
            <View key={index} style={styles.recommendedItem}>
              ...
              <View style={styles.recommendedTextContainer}>
                <AppText bold style={styles.recommendedTitle}>{item.title}</AppText>
                <AppText type='caption' >{item.desc}</AppText>
              </View>
              <TouchableOpacity style={styles.addBtnOutline}>
                <MaterialIcons name="add" size={20} color={MyTheme.primaryAccent} />
              </TouchableOpacity>
            </View>
          ))}
        </View>
...
const recommendedData = [
  { title: "Zen Masters", desc: "Daily meditation & focus", icon: "spa", iconColor: "#a855f7", bgColor: "rgba(168, 85, 247, 0.2)", borderColor: "rgba(168, 85, 247, 0.1)" },
  { title: "Page Turners", desc: "Read 15 mins every day", icon: "menu-book", iconColor: "#3b82f6", bgColor: "rgba(59, 130, 246, 0.2)", borderColor: "rgba(59, 130, 246, 0.1)" },
  { title: "Marathon Elites", desc: "Competitive long distance running", icon: "directions-run", iconColor: "#10b981", bgColor: "rgba(16, 185, 129, 0.2)", borderColor: "rgba(16, 185, 129, 0.1)" },
  { title: "Healthy Bites", desc: "Clean eating and meal prep tips", icon: "restaurant", iconColor: "#f97316", bgColor: "rgba(249, 115, 22, 0.2)", borderColor: "rgba(249, 115, 22, 0.1)" },
  { title: "Hydration Heroes", desc: "Track and meet water goals", icon: "water-drop", iconColor: "#0ea5e9", bgColor: "rgba(14, 165, 233, 0.2)", borderColor: "rgba(14, 165, 233, 0.1)" },
];
